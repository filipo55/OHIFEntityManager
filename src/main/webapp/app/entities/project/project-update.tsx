    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="ohifEntityManagerApp.project.home.createOrEditLabel">Create or edit a Project</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : projectEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="xnatIdLabel" for="project-xnatId">
                    Xnat Id
                  </Label>
                  <AvField id="project-xnatId" type="text" name="xnatId" />
                </AvGroup>
                <AvGroup>
